...
from al_yaqeen.mixins.views import ActionPermissionsMixin, UserFilterMixin
from al_yaqeen.permissions import DenyAll, IsOwner
...
class BaseCommentVS(ActionPermissionsMixin, ModelViewSet):
    ...
    def reply(self, request: Request, pk: int) -> Response:
        ...
        reply = serializer.save(user=request.user, article=comment.article)
...
class CommentViewSet(UserFilterMixin, BaseCommentVS):
    """
