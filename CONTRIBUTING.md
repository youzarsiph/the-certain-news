...
Thank you for considering contributing to the `al-yaqeen`! We appreciate your interest in helping us make this project better. Please take a moment to review these guidelines before submitting your contributions.
...
1. **Clone the Repository**:
   ...
   ```bash
   git clone https://github.com/youzarsiph/al-yaqeen.git
   cd al-yaqeen
   ```
...
If you encounter a bug or have a feature request, please [open an issue](https://github.com/youzarsiph/al-yaqeen/issues/new). When reporting:
...
By contributing to the `al-yaqeen`, you agree that your contributions will be licensed under the [MIT License](LICENSE).

## Support

For any questions or assistance, you can:

- Visit the [GitHub Discussions](https://github.com/youzarsiph/al-yaqeen/discussions).
- Open an issue in the [Issues](https://github.com/youzarsiph/al-yaqeen/issues) section.
